...
bed_Img = loadImage("Bed Room.png");
...
function setup() {
  ...
  button1=createButton("Feed Chip");
  button1.position(370,200);
  button1.mousePressed(feedDog);
 
  button2 = createButton("Add Food");
  button2.position(370,300)
  button2.mousePressed(addFood);

  button3 = createButton("Check food stock")
  button3.position(370,250);
  button3.mousePressed(foodStock)

  button4 = createButton("Walk Time");
  button4.position(1250,300);
  button4.mousePressed(walk);

  button5 = createButton("Washroom Time");
  button5.position(370,350);
  button5.mousePressed(washroom);

  button6 = createButton("Check for Vaccination");
  button6.position(1200, 350);
  button6.mousePressed(vaccination);

  button7 = createButton("Play Time");
  button7.position(1250,200);
  button7.mousePressed(garden);

  button8 = createButton("Nap Time");
  button8.position(1250,250);
  
  button8.mousePressed(sleep)

  var title = createElement('h2')
  title.html("My Pet Dog-Chip")
